...
INSERT INTO `tb_admin` VALUES (1,'seuemail@gmail.com','40bd001563085fc35165329ea1ff5c5ecbdbbeef',NULL);
...
CREATE TABLE `tb_noticias` (
  ...
  `data_de_pub` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `tb_usuarios` (
  ...
  `usuario` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `senha` varchar(300) COLLATE utf8_unicode_ci NOT NULL,
  `tempo` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-11-15 15:26:31
